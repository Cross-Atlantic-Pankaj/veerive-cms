...
export default function ContextForm({ handleFormSubmit }) {
   ...
   // ✅ Fix: Fetch posts only if they are not already fetched
    ...
    useEffect(() => {
        ...
        if (!editId) return;
        if (!Array.isArray(contexts.data) || contexts.data.length === 0) return;
        ...
        if (context) {
            ...
            setDate(new Date(context.date).toISOString().substring(0, 10));
        ...
        <div className="context-form-outer">
            <div className="context-form-container">
                ...
                <form onSubmit={handleSubmit} className="context-form">
                    ...
                    {hasSlider && (
                        <div className="form-section">
                            <h2 className="form-section-title">Slider Content</h2>
                                ...
                                {[...Array(10)].map((_, index) => {
                                    ...
                                    return (
                                        <div key={slideNumber} className="slide">
                                            <div className="field-group">
                                                <div style={{ flex: 1 }}>
                                                    <label htmlFor={`${slideNumber}Title`}>Slide {index + 1} Title</label>
                                                    <input
                                                        id={`${slideNumber}Title`}
                                                        type="text"
                                                        placeholder={`Enter slide ${index + 1} title`}
                                            ...
                                            <div className="field-group">
                                                <div style={{ flex: 1 }}>
                                                    <label htmlFor={`${slideNumber}Description`}>Slide {index + 1} Description</label>
                                                    <Quill
