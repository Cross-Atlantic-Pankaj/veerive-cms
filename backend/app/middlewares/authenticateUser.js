...
//     }
//     try {
//         const tokenData = jwt.verify(token, process.env.JWT_SECRET); // Verify token
//         req.user = { userId: tokenData.userId, role: tokenData.role }; // Attach user data to req
//         next();
//     } catch (err) {
...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        user: 'paich147@gmail.com', // Hardcoded email address
        pass: 'nyov zozm ttjz xydq',   // Hardcoded App Password (from Gmail settings)
    },
    tls: {
